...
const About = () => {
  ...
  return (
    <div className="min-h-screen from-gray-50 pt-26 via-white to-blue-50">
      {/* Hero Section */}
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 mb-20 items-center fade-in">
                ...
                <div className="bg-white rounded-2xl p-8 shadow-2xl border border-gray-100">
                  <div className="grid grid-cols-2 gap-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="text-center p-6 rounded-2xl bg-gradient-to-br from-gray-50 to-white border border-gray-100 hover-lift"
                      >
                        <div
                          className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${stat.color} rounded-full mb-4 mx-auto`}
                        >
                  ...
                  {/* Floating Elements */}
                  <div className="absolute -top-4 -right-4 bg-gradient-to-br from-blue-600 to-blue-700 p-4 rounded-2xl shadow-xl">
                    <TrendingUp className="w-8 h-8 text-white" />
                  </div>
                  <div className="absolute -bottom-4 -left-4 bg-gradient-to-br from-green-600 to-green-700 p-4 rounded-2xl shadow-xl">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {values.map((value, index) => (
              <div
                key={index}
                className={`${value.bg} p-8 rounded-2xl border border-gray-100 shadow-lg hover-lift transform hover:-translate-y-2 transition-all duration-300 group`}
              >
                <div
                  className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${value.color} rounded-xl text-white mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
                  {value.icon}
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto mb-12">
            {expertiseAreas.map((area, index) => (
              <div
                key={index}
                className="group bg-gradient-to-br from-gray-50 to-white p-6 rounded-2xl border border-gray-100 shadow-sm hover-lift hover:shadow-xl transition-all duration-300"
              >
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-gradient-to-br from-blue-50 to-blue-100 text-blue-600 rounded-xl group-hover:bg-blue-100 group-hover:scale-110 transition-all duration-300">
                    {area.icon}
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            {strengths.map((strength, index) => (
              ...
              >
                <div
                  className={`inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br ${strength.color} rounded-xl text-white mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
                  {strength.icon}
                </div>
              ...
              {milestones.map((milestone, index) => (
                ...
                >
                  <div className="lg:w-1/2 mb-6 lg:mb-0">
                    <div
                      className={`bg-white p-6 rounded-2xl border border-gray-100 shadow-lg hover-lift transition-all duration-300 ${
            ...
            {[
              ...
              <div key={index} className="group">
                <div className="relative">
                  ...
                  ></div>
                  <div className="relative bg-white p-8 rounded-2xl border border-gray-100 shadow-lg">
                    <div
                      className={`w-16 h-16 bg-gradient-to-br ${step.color} text-white rounded-xl flex items-center justify-center font-bold text-2xl mb-6 group-hover:scale-110 transition-transform duration-300`}
                    >
                      {step.step}
                    </div>
                    <h3 className="text-xl font-bold text-gray-900 mb-3">
